...
flatpak install flathub -y io.dbeaver.DBeaverCommunity --or-update -y && \
flatpak install flathub -y rest.insomnia.Insomnia --or-update -y && \
...
flatpak install flathub -y com.jetbrains.PyCharm-Community --or-update && \
