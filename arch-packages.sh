...
yay -S visual-studio-code-bin 1password bitwarden sublime-text-4 vscodium-bin --noconfirm --needed && \
yay -S telegram-desktop mpv mplayer --noconfirm --needed && \
...
yay -S vlc-plugin-ffmpeg --noconfirm --needed && \
